...
## Generated Datasets 📂
In order to access the generated model responses used for evaluating ATC, please contact **maorash@post.bgu.ac.il** to request a share invite on HuggingFace.
